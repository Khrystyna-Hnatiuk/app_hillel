...
const Layout = () => {
    ...
    return (
        <><div className={`min-h-screen ${theme === 'dark' ? 'bg-neutral-900 text-white' : 'bg-white text-black'}  flex flex-col`}>
            ...
            <main className={`${theme === 'dark' ? 'bg-neutral-900 text-white' : 'bg-white text-black'}px-8 pb-8`}>
                <Outlet />
            </main>       </div>
